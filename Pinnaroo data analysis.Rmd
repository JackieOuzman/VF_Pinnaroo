...
pinnaroo_paddock_area <- st_read("W:/VF/Pinnaroo/Spatial/Boundary_files/Pinnaroo_boundary.shp")
...
############################################################################################
#######  plot the spatial data to check fence name is correct ##############################
############################################################################################

# str(animal_GPS_data_sf_trans_clip)
# str(pinnaroo_Vf_area)
# unique(animal_GPS_data_sf_trans_clip$VF_area)
# unique(pinnaroo_Vf_area$VF_ID)
...
animal_GPS_data <- as.data.frame(animal_GPS_data_sf_trans_clip)
...
```{r number of cues1, message=FALSE, warning=FALSE, include=FALSE}
...
```{r write up GPS plots checks first, message=FALSE, warning=FALSE, include=FALSE}
##################################################################################
...
```{r write up GPS plots working out fence move 8 hrs data, message=FALSE, warning=FALSE, include=FALSE}
...
```{r write up GPS plots image, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r write up GPS plots time period, echo=FALSE, message=FALSE, warning=FALSE}
