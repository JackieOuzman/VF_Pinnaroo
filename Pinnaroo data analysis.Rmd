...
max(animal_GPS_data$local_time)
...
last_record <- animal_GPS_data %>% 
  filter(between(ymd_hms(local_time),
                 ymd_hms("2021-10-20 08:50:00"), ymd_hms("2021-10-20 08:55:00"))) 
...
```{r results -stimuli for ratio no facet, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
